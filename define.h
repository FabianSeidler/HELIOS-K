...
#define def_TOL                                                                \
  1.43e-17 // Tolerance in the Voigt
           // function 3.58e-9 2.48e-12 1.43e-17 3.25e-27 1.69e-33
#define def_TOLF 2.48e-12f // Tolerance in the Voigt function
#define def_nthmax 1048576 // Maximum number of threads for line and sort
                           // kernels
#define def_nlmax                                                              \
  32768 // Maximum number of lines per kernel launch, to prevent from time out
        // on Desktop machines
#define def_maxlines                                                           \
  1048576ll // maximum number of lines stored on the GPU, Should not be less
            // than maximum in HITEMP lines, must be long long int type
...
struct Line {
  ...
  long long int *iiLimitsAT_m,
      *iiLimitsAT_d; // limits for all blocks, mapped memory
  long long int *iiLimitsALT_m,
      *iiLimitsALT_d; // limits for all blocks, mapped memory
  long long int *iiLimitsART_m,
      *iiLimitsART_d; // limits for all blocks, mapped memory
  long long int *iiLimitsBT_m,
      *iiLimitsBT_d; // limits for all blocks, mapped memory
  long long int *iiLimitsCT_m,
      *iiLimitsCT_d; // limits for all blocks, mapped memory
};
#endif
